...
class SubstringOperation : public UnaryOperation {
 public:
  /**
   * @brief Get a reference to the singleton instance of this Operation for TODO.
   *
   **/
  const static SubstringOperation& Instance(const std::size_t start_position,
    ...
    const auto key_pair = std::make_pair(start_position, substring_length);
